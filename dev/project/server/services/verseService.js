...
const verseService = async () => {
    console.log('REAL verse data test');
...
// // const verseDayURL = `${process.env.BASE_URL}/${process.env.BIBLE_ID}/search?query=${verseID}`;
// const verseDayURL = `${process.env.BASE_URL}/${process.env.BIBLE_ID}`;
